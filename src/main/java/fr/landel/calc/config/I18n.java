...
public enum I18n {
    ...
    DIALOG_PREFERENCES_UNITY_LENGTH("dialog.preferences.unity.length"),
    DIALOG_PREFERENCES_UNITY_SPACE("dialog.preferences.unity.space"),
    DIALOG_PREFERENCES_VALUE_SPACE("dialog.preferences.value.space"),
