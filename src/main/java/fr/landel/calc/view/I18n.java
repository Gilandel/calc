...
public enum I18n {
    ...
    MENU_FUNCTIONS_YEARS("menu.functions.time.years"),
    MENU_FUNCTIONS_MONTHS("menu.functions.time.months"),
    MENU_FUNCTIONS_WEEKS("menu.functions.time.weeks"),
    MENU_FUNCTIONS_DAYS("menu.functions.time.days"),
    ...
    MENU_FUNCTIONS_MILLIS("menu.functions.time.millis"),
    MENU_FUNCTIONS_MICROS("menu.functions.time.micros"),
    MENU_FUNCTIONS_NANOS("menu.functions.time.nanos"),
    ...
    // DIALOG_FUNCTION_YEARS("dialog.function."),
    // DIALOG_FUNCTION_YEARS_TEXT("dialog.function.tan.text"),
