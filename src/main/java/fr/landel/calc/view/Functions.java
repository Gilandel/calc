...
public enum Functions {
    ...
    YEARS("year", I18n.DIALOG_FUNCTION_PARAM_DATE, I18n.DIALOG_FUNCTION_YEAR),
    MONTH("month", I18n.DIALOG_FUNCTION_PARAM_DATE, I18n.DIALOG_FUNCTION_MONTH),
    WEEK("week", I18n.DIALOG_FUNCTION_PARAM_DATE, I18n.DIALOG_FUNCTION_WEEK),
    DAY("day", I18n.DIALOG_FUNCTION_PARAM_DATE, I18n.DIALOG_FUNCTION_DAY),
    HOURS("hours", I18n.DIALOG_FUNCTION_PARAM_DATE, I18n.DIALOG_FUNCTION_HOURS),
    MINUTES("minutes", I18n.DIALOG_FUNCTION_PARAM_DATE, I18n.DIALOG_FUNCTION_MINUTES),
    SECONDS("seconds", I18n.DIALOG_FUNCTION_PARAM_DATE, I18n.DIALOG_FUNCTION_SECONDS),
    MILLISECONDS("milliseconds", I18n.DIALOG_FUNCTION_PARAM_DATE, I18n.DIALOG_FUNCTION_MILLISECONDS),
    MICROSECONDS("microseconds", I18n.DIALOG_FUNCTION_PARAM_DATE, I18n.DIALOG_FUNCTION_MICROSECONDS),
    NANOSECONDS("nanoseconds", I18n.DIALOG_FUNCTION_PARAM_DATE, I18n.DIALOG_FUNCTION_NANOSECONDS),
    NOW("now", I18n.DIALOG_FUNCTION_NOW);

    public static final String[] FUNCTIONS = Arrays.stream(Functions.values()).map(f -> f.getFunction()).toArray(String[]::new);
