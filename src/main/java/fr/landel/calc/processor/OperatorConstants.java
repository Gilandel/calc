...
public interface OperatorConstants {
    ...
    BiPredicate<Entity, Entity> IS_CONVERTIBLE = (a, b) -> b.isUnity() && a.getUnityType().equals(b.getUnityType());

    BiFunction<Entity, Entity, Entity> FUN_MULTIPLY = (a, b) -> {
        if (a.isNumber()) {
            return new Entity(a.getIndex(), a.getUnity().fromUnity(a.toUnity() * b.getValue()), a.getUnity());
        } else {
            return new Entity(a.getIndex(), b.getUnity().fromUnity(b.toUnity() * a.getValue()), b.getUnity());
        }
    };
    BiFunction<Entity, Entity, Entity> FUN_DEVIDE = (a, b) -> new Entity(a.getIndex(), a.getUnity().fromUnity(a.toUnity() / b.getValue()), a.getUnity());
}
