...
public class Params<T> {
    ...
    public static final Params<Double> VALUE = new Params<>(I18n.DIALOG_FUNCTION_PARAM_VALUE, Entity::isDecimal, I18n.DIALOG_ERROR_PARAM_VALUE);
    ...
    public static final Params<Double> ANGULAR = new Params<>(I18n.DIALOG_FUNCTION_PARAM_ANGULAR, Entity::isDecimal, I18n.DIALOG_ERROR_PARAM_ANGULAR);
    ...
    public static final Params<Double> COSINUS = new Params<>(I18n.DIALOG_FUNCTION_PARAM_COSINUS, Entity::isDecimal, I18n.DIALOG_ERROR_PARAM_COSINUS);
